...
* Alice generates a random string of bits of chosen length(which is usually over 1000 bits - but under computational limits, upto 500 bits are used in this model)
...
The final version of the simulation is BB84_Qiskit.ipynb(and BB84_Qiskit_Eve.ipynb to model what happens when Eve is present)

The files inside the ObjectOriented and Procedural are rough drafts of my earliest development stages(without qiskit) to understand the logic behind the technique
